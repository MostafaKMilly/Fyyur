...
class VenueForm(Form):
    ...
    website = StringField(
        'website', validators=[Length(-1, 120), URL(), Optional()]
    )
...
class ArtistForm(Form):
    ...
    image_link = StringField(
        'image_link', validators=[Length(-1, 500), URL()]
    )
    facebook_link = StringField(
        'facebook_link', validators=[Length(-1, 200), URL()]
    )
    website = StringField(
        'website', validators=[Length(-1, 200), URL()]
    )
